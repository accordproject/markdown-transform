...
This agreement begins on __[date] __and will run for a period of **[number]** **months.**
...
-  The supplier guarantees __uptime __only for items with a tick in the __Covered for uptime? __column.
...
*[Edit this table to reflect your own business. Sometimes this information is contained in a separate database or document. Often, the supplier will include extra details, like hardware serial numbers or software licence keys.]*
...
These uptime levels apply to items in the __Equipment, software and services covered __table that show a tick in the __Covered for uptime? __column.
