...
rules.VariableDefinition = (visitor: any, thing: any, children: any, parameters: any, resultString: any, resultSeq: any) => {
    const result = [resultString('{{'), resultString(thing.name), resultString('}}')];
    resultSeq(parameters, result);
};
rules.FormattedVariableDefinition = (visitor: any, thing: any, children: any, parameters: any, resultString: any, resultSeq: any) => {
    const result = [resultString('{{'), resultString(thing.name), resultString(' as "'), resultString(thing.format), resultString('"}}')];
    resultSeq(parameters, result);
};
rules.EnumVariableDefinition = (visitor: any, thing: any, children: any, parameters: any, resultString: any, resultSeq: any) => {
    const result = [resultString('{{'), resultString(thing.name), resultString('}}')];
    resultSeq(parameters, result);
};
rules.FormulaDefinition = (visitor: any, thing: any, children: any, parameters: any, resultString: any, resultSeq: any) => {
    const result = [resultString('{{%'), resultString(thing.code), resultString('%}}')];
    resultSeq(parameters, result);
};
rules.ConditionalDefinition = (visitor: any, thing: any, children: any, parameters: any, resultString: any, resultSeq: any) => {
...
rules.OptionalDefinition = (visitor: any, thing: any, children: any, parameters: any, resultString: any, resultSeq: any) => {
...
rules.WithDefinition = (visitor: any, thing: any, children: any, parameters: any, resultString: any, resultSeq: any) => {
    const next1 = `{{#with ${thing.name}}}`;
    const next2 = '{{/with}}';
    const result = [resultString(next1), children, resultString(next2)];
    resultSeq(parameters, result);
};
rules.JoinDefinition = (visitor: any, thing: any, children: any, parameters: any, resultString: any, resultSeq: any) => {
...
// Container blocks
rules.ListBlockDefinition = (visitor: any, thing: any, children: any, parameters: any, resultString: any, resultSeq: any) => {
...
rules.ClauseDefinition = (visitor: any, thing: any, children: any, parameters: any, resultString: any, resultSeq: any) => {
