...
import { CommonMarkUtils, TemplateMarkModel } from '@accordproject/markdown-common';
import { formulaName } from './util';

const { getAttr } = CommonMarkUtils;
...
const rules: any = { inlines: {}, blocks: {} };
