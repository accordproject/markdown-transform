export declare namespace markdown_template {
    let docs: string;
    let fileFormat: string;
    function templatemark_tokens(input: any, parameters: any, options: any): object;
}
export declare namespace templatemark_tokens_1 {
    let docs_1: string;
    export { docs_1 as docs };
    let fileFormat_1: string;
    export { fileFormat_1 as fileFormat };
    export function templatemark(input: any, parameters: any, options: any): Promise<object>;
}
export declare namespace templatemark_1 {
    let docs_2: string;
    export { docs_2 as docs };
    let fileFormat_2: string;
    export { fileFormat_2 as fileFormat };
    export function markdown_template_1(input: any, parameters: any, options: any): string;
    export { markdown_template_1 as markdown_template };
}
...
export declare namespace commonmark_tokens_1 {
    ...
    export function commonmark(input: any, parameters: any, options: any): Promise<object>;
}
...
export declare namespace ciceromark_tokens_1 {
    ...
    export function ciceromark(input: any, parameters: any, options: any): Promise<object>;
}
export declare namespace commonmark_1 {
    let docs_7: string;
    export { docs_7 as docs };
    let fileFormat_7: string;
    ...
    export function ciceromark_1(input: any, parameters: any, options: any): object;
    export { ciceromark_1 as ciceromark };
    export function plaintext(input: any, parameters: any, options: any): string;
}
export declare namespace ciceromark_2 {
    let docs_8: string;
    export { docs_8 as docs };
    let fileFormat_8: string;
    ...
    export function commonmark_2(input: any, parameters: any, options: any): object;
    export { commonmark_2 as commonmark };
    export function ciceromark_parsed(input: any, parameters: any, options: any): any;
}
export declare namespace ciceromark_parsed_1 {
    let docs_9: string;
    ...
    export function ciceromark_3(input: any, parameters: any, options: any): object;
...
export declare namespace plaintext_1 {
    ...
    let fileFormat_10: string;
    export { fileFormat_10 as fileFormat };
    export function markdown_2(input: any, parameters: any, options: any): any;
    export { markdown_2 as markdown };
}
export declare namespace ciceroedit {
    let docs_11: string;
    export { docs_11 as docs };
    let fileFormat_11: string;
    export { fileFormat_11 as fileFormat };
    export function ciceromark_parsed_2(input: any, parameters: any, options: any): object;
    export { ciceromark_parsed_2 as ciceromark_parsed };
}
export declare namespace ciceromark_unquoted_1 {
    let docs_12: string;
    export { docs_12 as docs };
    let fileFormat_12: string;
    export { fileFormat_12 as fileFormat };
    export function ciceromark_parsed_3(input: any, parameters: any, options: any): any;
    export { ciceromark_parsed_3 as ciceromark_parsed };
}
export declare namespace html_1 {
    let docs_13: string;
