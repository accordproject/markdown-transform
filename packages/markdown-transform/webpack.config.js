...
module.exports = {
    ...
    plugins: [
        ...
        // Some transitive deps reference the Node `process` global directly. webpack 5
        // no longer polyfills this, so we provide a minimal browser shim.
        new webpack.ProvidePlugin({ process: 'process/browser' }),
        // jsdom is reachable through markdown-html, but its `require('jsdom')` is gated
        // by `typeof DOMParser === 'undefined'`, which is false in browsers.
